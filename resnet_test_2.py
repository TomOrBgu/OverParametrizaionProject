...
def create_experiment_folder(model_names, args):
    ...
    folder_name = f"resnet_{model_names_str}_lr{args.lr}_batch{args.batch_size}_noise{int(args.noise_level*100)}_epochs{args.epochs}_optimizer{args.optimizer}_{args.dataset}_{current_date}"
...
def train_and_evaluate(model_func, args):
    ...
    for epoch in range(args.epochs):
        ...
        classification_discrepancy, jsd_discrepancy, outputs_discrepancy, softmax_discrepancy = compute_dispersion(net1, net2, trainloader)
